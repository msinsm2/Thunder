# A Thunder of Dragons — Franchise Workspace
...
This folder lives in the `Thunder` Git repository, so every change is tracked and nothing is lost.
To keep a copy on your own computer, clone the repository once and then `git pull` whenever you want
the latest — see the note the assistant left in chat for the exact steps.
